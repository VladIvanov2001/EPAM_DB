...
INSERT INTO USERS(FIRST_NAME, SECOND_NAME, EMAIL, LOGIN) SELECT FIRST_NAME, LAST_NAME, EMAIL, NICKNAME from EXDATA;
...
INSERT INTO COMPOSITION(NAME_OF_SONG, DURATION_OF_COMPOSITION, COUNT_OF_LIKES, COUNT_OF_REPOSTS, COUNT_OF_LISTENING, RATING, GENRE, STYLE, DIRECTION, ID_ALBUM) 
       SELECT COMPOSITION_NAME, LENGTH, COMPOSITION_LIKES, dbms_random.value(1, 10), LISTEN, dbms_random.value(1, 10), MUSIC_TYPE, MUSIC_TYPE, MUSIC_TYPE, 1 FROM EXDATA;
...
INSERT INTO PLAYLIST_CONTAIN(ID_COMPOSITION, ID_PLAYLIST, ID_ALBUM) SELECT dbms_random.value(1, 3),dbms_random.value(1, 2),dbms_random.value(1, 3) from dual;
INSERT INTO PLAYLIST_CONTAIN(ID_COMPOSITION, ID_PLAYLIST, ID_ALBUM) SELECT dbms_random.value(1, 3),dbms_random.value(1, 2),dbms_random.value(1, 3) from dual;
...
INSERT INTO USER_PLAYLIST(ID_USER, ID_PLAYLIST) SELECT dbms_random.value(1, 3), dbms_random.value(1, 2) from dual;

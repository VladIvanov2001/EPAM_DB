...
CREATE UNIQUE INDEX USER_STATE_ID_COMPOSITION ON USER_STATE (ID_COMPOSITION ASC);
CREATE UNIQUE INDEX USER_STATE_ID_USER ON USER_STATE (ID_USER ASC);
CREATE UNIQUE INDEX USER_STATE_ID_ALBUM ON USER_STATE (ID_ALBUM ASC);

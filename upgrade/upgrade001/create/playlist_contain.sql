...
CREATE UNIQUE INDEX PLAYLIST_CONTAIN_ID_COMPOSITION ON PLAYLIST_CONTAIN (ID_COMPOSITION ASC);
CREATE UNIQUE INDEX PLAYLIST_CONTAIN_ID_PLAYLIST ON PLAYLIST_CONTAIN (ID_PLAYLIST ASC);
CREATE UNIQUE INDEX PLAYLIST_CONTAIN_ID_ALBUM ON PLAYLIST_CONTAIN (ID_ALBUM ASC);
